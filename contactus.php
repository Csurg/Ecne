...
<div class="container px-4 px-lg-5">
    ...
    <h1 class="fw-light my-4 text-center">Need any help? <br> You can find us here!</h1>
    ...
    <div class="row gx-4 gx-lg-5">
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <p class="card-text text-center"> <a href="mailto:epets2024@gmail.com">epets2024@gmail.com</a></p>
                </div>
        ...
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <div class="card-body">
                    <h2 class="card-title text-center">Phone</h2>
                    <p class="card-text text-center"><a href="tel:12223334444">024-777-8888</a></p>
                    <p class="card-text text-center"><a href="tel:12223334444">066-157777777</a></p>
                    <p class="card-text text-center"><a href="tel:12223334444">222-333-4444</a></p>
                </div>
        ...
        <div class="col-md-4 mb-5">
            <div class="card h-100">
                <div class="card-body">
                    <h2 class="card-title text-center">Address</h2>
                    <p class="card-text text-center">
                        <a href='https://maps.google.com/?q=Marka Oreškoviċa 16 Subotica' target="_blank">Marka Oreškoviċa 16 Subotica</a></p>
                </div>
